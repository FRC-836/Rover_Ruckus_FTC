...
@TeleOp(name = "Kiwi PID",group = "A")
public class KiwiPID extends OpMode {
    ...
    public void loop() {
        ...
        setPidDrive(forwardPower, strafePower, turnPower);
    }

    private void setPidDrive(double forwardPower, double strafePower, double turnPower) {
