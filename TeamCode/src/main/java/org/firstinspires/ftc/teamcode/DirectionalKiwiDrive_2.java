...
@TeleOp(name = "Directional Kiwi Drive 2",group = "A")
public class DirectionalKiwiDrive_2 extends OpMode {
    ...
    PID_Controller turnPid = new PID_Controller(0.02,0.0,0.0015);
    ...
    public void loop() {
        ...
        double directionUp = -gamepad2.right_stick_y;
        double directionRight = gamepad2.right_stick_x;
